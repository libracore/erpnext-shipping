...
def fetch_shipping_rates(pickup_from_type, delivery_to_type, pickup_address_name, delivery_address_name,
    shipment_parcel, description_of_content, pickup_date, value_of_goods, pickup_company, delivery_company,
    ...
    pickup_address['company'] = pickup_company
...
def create_shipment(shipment, pickup_from_type, delivery_to_type, pickup_address_name,
        ...
        value_of_goods, service_data, pickup_company, delivery_company,
        shipment_notific_email=None, tracking_notific_email=None,
